...
class ZoomErrorHandler {
  ...
  static ZoomErrorType _inferErrorType(String message) {
    ...
    } else if (lowerMessage.contains('dimension') || lowerMessage.contains('size')) {
      return ZoomErrorType.invalidDimensions;
    } else if (lowerMessage.contains('matrix') || lowerMessage.contains('transform')) {
...
class _ZoomErrorBoundaryState extends State<ZoomErrorBoundary> {
  ...
  void _handleError(dynamic error, StackTrace stackTrace) {
    final zoomError = ZoomErrorHandler._createZoomError(
      error,
      stackTrace,
      null,
